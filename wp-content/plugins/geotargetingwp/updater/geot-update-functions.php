...
function geot_upgrade_3401_builder_prepare() {
	...
	set_transient( 'geot_upgrade_3401_builder_running', $builder, MINUTE_IN_SECONDS * 10 );
...
function geot_upgrade_3401_builder_action() {
	...
	$builder = get_transient( 'geot_upgrade_3401_builder_running' );
	...
	try {
		...
		delete_transient( 'geot_upgrade_3401_builder_running' );
		return [ 'status' => 'error', 'msg' => $e->getMessage() ];
	}
