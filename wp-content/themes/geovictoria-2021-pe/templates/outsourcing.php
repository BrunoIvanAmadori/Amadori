			...
			<div class="row gx-5 anime-fadein mb-5">
				...
				<div class="col-lg-8 pe-lg-5 mb-5">
					<div class="testimonal__video text-center">
						<video controlsList="nodownload" width="100%" poster="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/outsourcing/caso-outsourcing-comsatel-thumb.jpg" controls>
							<source src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/outsourcing/caso-outsourcing-comsatel.mp4" type="video/mp4">
						</video>
					</div>
				</div>

				<div class="col-lg-4 text-center text-lg-start">
					<h3 class="fw-bold">Caso de éxito: COMSATEL</h3>
					<img class="testimonial__logo--small" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/logos/comsatel-logobnw.png" />
					<p>
						<!-- <img class="arrow-quote--left" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/call-to-action/arrow.svg"> -->
						<i>"Podemos controlar al personal de campo y al personal de provincias ya que GeoVictoria tiene una APP para que nuestro personal pueda marcar."</i>
					...
					<div class="row justify-content-center justify-content-lg-start">
						<span>
							<span class="fw-bold">Jimmy Barrientos</span></br>
							<small>Jefe RRHH</small>
