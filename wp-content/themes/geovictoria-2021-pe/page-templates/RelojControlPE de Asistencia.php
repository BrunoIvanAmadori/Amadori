<?php
/*
Template Name: RelojControlPE Asistencia                                                                                                                                                       
*/
get_header();
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 titulo titulo-acceso">
                    <h1>Reloj Control<span class="sub-relojcontrol"> de Asistencia</span></h1>
                    <p>El mejor sistema para el control y gestion de asistencia en latinoamérica, ahora disponible en Perú. Gracias al sofisticado reloj control proporcionado por GeoVictoria, 
                    contarás con datos fidedignos y en tiempo real sobre la asistencia de sus trabajadores en sus puestos asignados.</p>
...
<section id="forma1-section2" class="acceso">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <h2 class="titulo-azul">¿Cómo funciona el reloj control de asistencia disponible en Perú?</h2>
                <p>El reloj control de asistencia es el sistema de control y gestión de personas más eficiente del mercado.</p>
                ...
                El reloj control de asistencia almacena la información del ingreso y egresos de trabajadores en tiempo real.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Equipos de reloj control para la asistencia</h2>
                </div>
                <div class="col-lg-4 col-sm-6">
                    ...
                    <p class="text-justify">
                        ...
                        Aplicable a reloj control con huelleros USB y reloj control box. 
                    </p> 
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">
                        El reloj control box de asistencia lee rasgos faciales. El equipo es capaz de diferenciar una fotografía y un rostro real. 
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <p class="text-justify">
                        Este reloj control de asistencia puede registrar 600 palmas, 3.000 huellas y hasta 10.000 tarjetas. 
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <h3 class="text-center">Lector de tarjeta:</h3>
                    <p class="text-justify">
                        Para quienes prefieren la clásica tarjeta de registro para la entrada y salida de trabajadores de los lugares donde así lo ha establecido la empresa, 
                        GeoVictoria tiene un reloj control de asistencia que utiliza tarjetas enroladas para  tus trabajadores. 
                        E incluso, ¡son reutilizables! Olvídate de comprar nuevas tarjetas.
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">
                        Un reloj control de asistencia con una protección extrema. El box será protegido por un gabinete metálico a prueba de robos y daños externos.
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">
                        Ideal para industrias, la minería o construcción. Elaborada con un revestimiento de goma de alta protección, está diseñado para ser fácilmente transportable. 
                        En este reloj control de asistencia, los trabajadores pueden registrar por huella dactilar, PIN o tarjeta. Cuenta con conexión 3G para zonas extremas o de dificil conectividad.
                    </p> 
                </div>
            </div>
        </div>
...
<section id="forma2-section1" class="acceso">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center titulo-relojcontrol">Características del reloj control de asistencia</h2>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <p>Sea en un gabinete o impresora, el reloj control de asistencia de  GeoVictoria, puede ser instalado en el lugar donde la empresa determine. 
                Y si el Usuario lo necesita, el reloj control de asistencia imprimirá un ticket que comprueba su asistencia.</p>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>El reloj control de asistencia de GeoVictoria facilita el registro del ingreso y egreso del personal por medio de un reloj control según la necesidad de tu empresa.</p>
                <p>Los usuarios generan marcas gracias a registros biométricos por huella dactilar, rostro o palma. 
                Esta información, es subida a una nube de almacenamiento donde, gracias al sofisticado software de reporteria de GeoVictoria, generas poderosos reportes en tiempo real.</p>
            ...
            <div class="col-lg-6">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>El reloj control de asistencia de GeoVictoria, opera con las reglas del Decreto Supremo N°011-2006-TR. 
        ...
        <div class="container acceso3">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p class="text-justify">Equipos certificados y validados por la  Superintendencia Nacional de Fiscalización Laboral (Sunafil). La última generación de aparatos biométricos de reloj control de asistencia en el mundo.</p> 
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">El reloj control de asistencia solo necesita un cable de corriente y  conexión LAN de la empresa y ¡listo!, ya puede ser utilizado.
...
<section id="forma1-section6">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>Conoce la opinión de nuestro reloj control de asistencia</h2>
