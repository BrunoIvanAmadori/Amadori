			...
			<div class="col-12 col-md-6 mb-5">
				<div class="align-self-center pe-md-3">
					...
					<h5 class="gray fw-light mb-3 anime-fadein">
						We partner with large companies to make your work much more efficient.
						Meet our allies around the world.
					</h5>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						...
						<div class="partners-estrategicos__partner card">
							...
							<div class="card-body">
								...
								<p class="card-text">
									Largest IT company in the
									world. Our services operate
									thanks to the Azure cloud.
								</p>
								<a href="https://www.microsoft.com/" type="button" class="button--blue">See more</a>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<div class="partners-estrategicos__partner card">
							...
							<div class="card-body">
								...
								<a href="https://www.dt.gob.cl/" type="button" class="button--blue">See more</a>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<div class="partners-estrategicos__partner card">
							...
							<div class="card-body">
								...
								<a href="https://redderrhh.com/" type="button" class="button--blue">See more</a>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<div class="partners-estrategicos__partner card">
							...
							<div class="card-body">
								...
								<p class="card-text">
									Leading community of high impact entrepreneurs in the world.
								</p>
								<a href="https://endeavor.org/" type="button" class="button--blue">See more </a>
							</div>
						</div>
					</div>
	...
	<section class="container-fluid partners-estrategicos__container">
		<div class="container">
			...
			<div class="partners-estrategicos__headline col-12 d-flex flex-column align-items-center mb-5 text-center">
				...
				<div class="col-12 col-lg-9 anime-fadein">
					<p class="fw-light">
						We work with the most experienced human resources solutions on the market. All our remuneration calculations are supported with our access and attendance management system.
					</p>
				</div>
	...
	<section class="container-fluid partners-estrategicos__container">
		<div class="container">
			...
			<div class="partners-estrategicos__headline col-12 d-flex flex-column align-items-center mb-5 text-center">
				...
				<div class="gray mb-3 col-12">
					<h1 class="fw-bold">Operational management</h1>
				</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3">
					...
					<h2 class="white fw-bold mb-3">
						Do you want to be part of our partner network?
					</h2>

					<p class="anime-fadein">
						Together we can improve our customer experience! Be part of a world of management and analytics with GeoVictoria. Let's talk!
					</p>
