...
<main id="primary" class="site-main">
	...
	<div class="position-relative">
		...
		<section class="container clients col-12 mb-3">
			<h2 class="text-center gray section-title fw-light anime-fadein">
				Our clients already <br> <span class="fw-bold"> manage their staff with us</span></h2>
	...
	<section class='container'>
		...
		<div class="row mb-5 justify-content-center">
			<h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">
				The <span class="fw-bold"> security staff management </span> for your clients <span class="fw-bold"> like you've never seen it before </span></h2>
		</div>
		...
		<div class="row gx-5 gy-4 mb-5">
			...
			<div class="col-12 col-md-6 anime-fadein">
				<h3 class="fw-bold mb-4">Manage, decide, save</h3>
				<p>Do you have problems with the management of your security personnel?
					<b> They do not arrive at the assigned place? Do you know if your client is receiving the service?</b>
				</p>
				<p>
					With GeoVictoria, manage, assign rounds and track your external security personnel in just one click. We deliver accurate information about the security guards in assigned areas.</p>

				<p>Secure contracts with your clients and avoid fines for non-compliance. You will be able to make decisions instantly.</p>

				<p><b>Verify that your clients' facilities are protected!</b></p>
			</div>
		</div>
		...
		<div class="row gy-4 flex-column-reverse flex-md-row">
			<div class="col-12 col-md-6 anime-fadein">
				...
				<p>Efficiently optimize data. With GeoVictoria use the information of the assistance of external security personnel <b> to save time and money.</b></p>
				<p>Visualize compliance with working hours. Control overtime hours. Schedule alerts for delays or absences. <b> Make and plan shifts according to demand.</b></p>
				<p>GeoVictoria helps you empower and simplify your tasks.</p>
			</div>
			<div class="col-12 col-md-6 d-flex flex-column justify-content-center">
	...
	<div class="position-relative">
		...
		<section class="d-flex flex-column container justify-content-between features">
			<div class="row">
				<h2 class="text-center fw-bold gray section-title anime-fadein">Save, upgrade, simplify<br><span class="fw-light">
						Welcome to a world of management</span><br> </h2>
			</div>
			...
			<div class="row justify-content-center anime-fadein-childs">
				<div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
					...
					<h6 class="fw-bold">Manage staff
					</h6>
					<p>Build profiles and groups of external personnel adapted to the different work points and assigned days.</p>
				</div>

				<div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
					<img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/icons/map-geo.svg" />
					<h6 class="fw-bold">Coverage compliance</h6>
					<p>Monitoring of rounds and tasks of the guards in the field. Visualize the areas where security personnel are working.</p>
				</div>
	...
	<section class="d-flex flex-column container justify-content-between">
		<div class="row gx-5 anime-fadein">
			...
			<div class="col-lg-4">
				<h2 class="fw-bold">Success story: ISEG</h2>
				<p>
					<!-- <img class="arrow-quote--left" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/call-to-action/arrow.svg"> -->
					<i>"GeoVictoria allowed us to leave the log books to do an automated marking.
						Today we know before our clients if the guard has arrived or has not arrived" </i>
	...
	<div class="container-fluid bg-blue-2">
		<section class="d-flex justify-content-between container why-us">
			<div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3 anime-fadein">
				...
				<p>
					Control all your daily operations and verify that the planned personnel are there.
					<span class="fw-bold"> Keep your customers calm and happy.</span>
				</p>
