...
<section class="hero container mt-5">
	<div class="row w-100 d-flex flex-column flex-md-row justify-content-between align-items-center h-100">
		...
		<div class="hero__graphics col-12 col-md-6">
			<img class="anime-pop" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/pricer/header-pricer.png'>
		</div>
	</div>
</section>
				...
				<article class="element column ml0" style="height: auto;width: auto;margin-top: unset;">
					<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-2 gv-align-center" style="padding:0">
							<img alt="" class="img-dt" src="<?php echo get_template_directory_uri() ?>/gvcalc/img/reg_cl.jpg" width="80px" height="80px">
						</div>
					</div>
					<div id="banner-side" style="width: 100%; display: none;">
						<img alt="" class="" src="<?php echo get_template_directory_uri() ?>/gvcalc/img/banner-side.png" onclick="modalAction('cotizacion-modal')" style="width: 100%; height:auto;">
					</div>
					...
					<div class="is-vcentered" style="width: 100%;">
						<div class="gv-align-center">
							<img id="industria-img" alt="" class="" src="<?php echo get_template_directory_uri() ?>/gvcalc/img/ind_ot.png" style="width: 100%; height:auto;">
						</div>
					</div>
