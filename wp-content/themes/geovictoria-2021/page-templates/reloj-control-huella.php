...
/*
Template Name: Reloj Control con Huella
*/
...
<main id="primary" class="site-main">
            ...
            <div class="col-12 col-md-6 mb-5">
                <div class="align-self-center pe-md-3 text-lg-end text-center">
                    ...
                    <h1 class="gray mb-3 fw-bold">
                        Reloj Control con Huella
                    </h1>
                    <p class="fw-light mb-4 anime-fadein">
                        El mejor sistema para el control y gestión de asistencia en latinoamérica. Gracias al sofisticado reloj control con huella dactilar proporcionado por GeoVictoria,
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">¿Cómo funciona
                el <b>reloj control con huella</b>?</span></h2>
        </div>
        ...
        <div class="row gx-5 gy-4 mb-5">
            ...
            <div class="col-12 col-md-6 anime-fadein">
                <p>El reloj control con huella es el sistema de control y
    ...
    <section class="d-flex flex-column container justify-content-between features">
        <div class="row">
            <h2 class="text-center fw-bold gray section-title anime-fadein"><span class="fw-light">Tipos de <b>reloj control con huella dactilar</b></span></h2>
        </div>

        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/reloj-control-box.png" />
        ...
        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/anti-vandalico.png" />
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <div class="col-12">
                <h2><span class="fw-light">Características del reloj control con huella</span></h2>
            </div>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <h2><span class="fw-light">Características del <b>Reloj Control con Huella Dactilar</b> de GeoVictoria</span></h2>
