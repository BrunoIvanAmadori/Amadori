...
/*
Template Name: Reloj Control Biométrico
*/
...
<main id="primary" class="site-main">
            ...
            <div class="col-12 col-md-6 mb-5">
                <div class="align-self-center pe-md-3 text-lg-end text-center">
                    ...
                    <p class="fw-light mb-4 anime-fadein">
                        ...
                        Gracias al sofisticado <b>reloj control biométrico</b>
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">¿Cómo funciona
                el <b>reloj control biométrico</b>?</span></h2>
        </div>
        ...
        <div class="row gx-5 gy-4 mb-5">
            ...
            <div class="col-12 col-md-6 anime-fadein">
                <p>El reloj control biométrico es el sistema de control y
                ...
                <p>El aparato proporcionado por GeoVictoria permite el
                    ...
                    de su presencia en el punto de trabajo. El reloj control biométrico almacena la información del ingreso y
    ...
    <section class="d-flex flex-column container justify-content-between features">
        <div class="row">
            <h2 class="text-center fw-bold gray section-title anime-fadein"><span class="fw-light">Tipos de <b>reloj control biométrico</b></span></h2>
        </div>
        ...
        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>Registrar la asistencia de tus colaboradores es más fácil cuando solo necesitan su huella dactilar. Aplicable a reloj control biométrico con huelleros USB y reloj control box.</p>
            </div>
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>El reloj control box biométrico que lee rasgos faciales. El equipo es capaz de diferenciar una fotografía y un rostro real. Puede almacenar hasta 100 mil caras. Especial para empresas que buscan innovadores métodos de marcaje.</p>
            </div>
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>Este reloj control de asistencia biométrico puede registrar 600 palmas, 3.000 huellas y hasta 10.000 tarjetas. Con una verificación de identidad menor a un segundo, tiene avanzados algoritmos biométricos de reconocimiento de palma y huella digital. Ideal para empresas que buscan un versátil reloj control de asistencia.</p>
            </div>
        </div>
        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>El reloj control biométrico cuenta con un gabinete metálico a prueba de robos y daños externos.</p>
            </div>
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>Ideal para faenas mineras o de construcción. Elaborada con un revestimiento de goma de alta protección, está diseñado para ser fácilmente transportable. En este reloj control biométrico, los trabajadores pueden registrar por huella dactilar, PIN o tarjeta. Cuenta con conexión 3G para zonas extremas.</p>
            </div>
        </div>
    </section>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <div class="col-12">
                <h2><span class="fw-light">Características del <b>reloj control biométrico</b></span></h2>
            </div>
            <div class="d-flex col-12 px-4 mt-4 flex-wrap">
                <div class="col-12 col-md-6 mt-5">
                    ...
                    <p>El <b>reloj control biométrico</b> se adapta tanto a las
                ...
                <div class="col-12 col-md-6 mt-5">
                    ...
                    <p>Según tu necesidad, puedes elegir tu <b>reloj control de asistencia</b> con un sistema de alimentación ininterrumpida.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <h2><span class="fw-light">Características del <b>reloj control biométrico</b> de GeoVictoria</span></h2>
            ...
            <div class="d-flex col-12 col-md-6 px-4 mt-4 flex-column">
                <h6 class="fw-bold">Validados por la Dirección de Trabajo (DT):</h6>
    ...
    <div class="position-relative">
        ...
        <section class='container'>
            <div class="row mb-5 justify-content-center">
                <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">Beneficios del <b>reloj control biométrico</b> </h2>
            </div>
    ...
    <div class="position-relative">
        ...
        <section class="d-flex flex-column container justify-content-between text-center">
            <div class="row gx-5 anime-fadein mb-5">
                <h2 class="text-center mb-5">Conoce la opinion de nuestro reloj control biométrico</h2>
