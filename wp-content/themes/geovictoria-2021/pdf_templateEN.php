...
<!DOCTYPE html>  
   ...
   <head>
   <meta charset="UTF-8">
   <title>Report GeoVictoria</title>
   ...
   <div class="j-container"> 
      <div class="j-main">
         <div class="my_content">
            <div style="vertical-align:middle;padding-top:2px;"><h1>Hello <span>'. $_GET['fn'] . " " . $_GET['fap'] .',</span></h1></div><br>
            <div style="padding-bottom:10px">
				<div style="width: 80%; float:left">
				   ...
				   <h2>Total of employees: <span>'. $_GET['uto'] .'</span> &nbsp;&nbsp;&nbsp;Plan type: <span>'. $_GET['p'] .'</span></h2>
				</div>

				<div style="width: 20%; float:right" align="center">
					<p>Software validated by</p>
				   <img src="'. $base64_reg .'">
				</div>			
		...
		if($_GET['tas'] > 0 ){ 
            ...
            <div>
				<div style="width: 28%; float:left;margin-top: -20px;">
				   <h2>Attendance and shift control
                   </h2>
				</div>
            ...
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct">Power BI Dashboard</h2>
				</div>	
            ...
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct">Custom Reports</h2>
				</div>	
				<div style="width:auto; float:right;">
            ...
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct">App Forms</h2>
				</div>	
				<div style="width:auto; float:right;">
            ...
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct" >Shift Optimized</h2>
				</div>	
				<div style="width:auto; float:right;">
		...
		{ echo '
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct">Integrations with other systems</h2>
				</div>	
				<div style="width:auto; float:right;">
		...
		if($_GET['tso'] > 0){ echo '
            <div>
				<div style="width: 74%; float:left;">
				   <h2 class="subproduct">24/7 Support</h2>
				</div>	
				<div style="width:auto; float:right;">
		...
		';
			...
			<div style="font-size: smaller;">
				<p><i>* This document provides approximate values. Hardware, installations, customizations and complex integrations are not included. We ask you to please speak with one of our executives to obtain a final value. Reference values ​​using the UF of the day. This quote offers values ​​up to 1000 users.
                </i></p>
			</div>			
		...
		<div class="my_content">
			...
			<div style="position:relative;margin-top:-10px;width: 46%; float:left;">
			   <h3>¿WHAT DOES GEOVICORIA DO?</h3>
			   <p>GeoVictoria is a workforce management tool,
               focused on improving their operational efficiency, through a
               platform that delivers accurate information in real time</p>
				
				<img src="'. $base64_quehace .'">
			</div>	
			<div style="width:auto; float:right;">
				<h3>INTEGRATED WITH ERP SOFTWARES                </h3>
				<ul style= "list-style-image: url(\''. $base64_check .'\')">
				  <li style="margin: 0 0 15px 0;">We have an integration API                  </li>
				  <li style="margin: 0 0 15px 0;">Integrable with ERP compensation systems                  </li>
				  <li style="margin: 0 0 15px 0;">100% cloud solutions microsfot azure</li>
				  <li style="margin: 0 0 15px 0;">More than 1 millions users</li>
				</ul>
			</div>	
		</div>	   
