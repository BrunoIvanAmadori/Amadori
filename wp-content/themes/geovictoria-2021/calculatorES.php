<section class="fondo-personaje">
		...
		<div class="title-precio">
			<h2>Precios</h2>
			<p>a la medida de tu empresa</p>
		</div>
	</section>

	<section class="topbox">
		<div class="gv-container"><h2 class="gv-h2 topbox-title">Calcula tu tarifa</h2><p class="topbox-description">Selecciona el número de empleados, los módulos que te interesan y tu industria <br> <b>Obtendrás el precio en sólo 3 clics.</b> Cobramos según la cantidad de usuarios activos.</p></div>
	</section>
		...
		<div class="gv-container" style="height: auto;">
			...
			<div class="calculator-info">
				<div class="columns is-vcentered">
					<div class="column is-3 gv-align-center quantity-container"><p>N° de empleados</p><input class="input" id="total-empleados-input" oninput="totalEmpleadosAction()" placeholder="1" type="text"></div>
			...
			<div class="elements-container has-text-centered">
				...
				<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
					...
					<div class="column is-2 gv-align-center" style="padding:0">
						<img alt="" class="img-dt" src="/wp-content/themes/geovictoriacom/gvcalc/img/reg_cl.jpg" width="80px" height="80px">
					</div>	
				</div>
				...
				<div class="gv-align-left" style="width: 100%;max-width: fit-content;">
					<span class="slide-labels"><b>Subproductos:</b></span><span id="subproductos-box" class="slide-labels"></span>
				</div>
		...
		<div class="gv-container">
			<div class="tabs-inner-container">
				...
				<div class="tabs is-centered" id="tabs-list">
					<ul><li class="tab asist-contain is-active" id="asist-tab"><a onclick="activeTab('asist-contain', 'asist-tab')">Control de asistencia y turnos</a></li><li class="tab acces-contain" id="acces-tab"><a onclick="activeTab('acces-contain', 'acces-tab')">Control de Acceso</a></li><li class="tab comed-contain" id="comed-tab"><a onclick="activeTab('comed-contain', 'comed-tab')">Portal de Comedor y Casino.</a></li><li class="tab extern-contain" id="extern-tab"><a onclick="activeTab('extern-contain', 'extern-tab')">Portal de Externos</a></li><li class="tab adicio-contain" id="adicio-tab"><a onclick="activeTab('adicio-contain', 'adicio-tab')">Adicionales</a></li></ul>
				</div>
...
•	<b>BOX:</b> registra tu asistencia desde un reloj control con o sin contacto (biometría facial, de palma o huella dactilar). Conectividad Ethernet, wifi, 3/4g.</p>
	  ...
	  <div class="modal-content">
		<div class="gv-modal-card" style="z-index: 2;width: 450px;">
		  <div class="gv-modal-card-header">
			<span id="step1-title"><h4 class="gv-h4">Estás a <b>1 paso</b> de descargar tu informe</h4></span><span id="step2-title" style="display: none"><h4 class="gv-h4">Cotización</h4></span>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input name="name" type="text" class="form-control" id="validationDefault01" placeholder="Nombre completo"  required>
    </div>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input name="company" type="text" class="form-control" id="validationDefault03" placeholder="Empresa" required>
    </div>
	...
	<div class="col-md-6 mb-3">
      ...
      <div class="input-group">
        ...
        <input name="phone" type="text" class="form-control" id="validationDefaultUsername" placeholder="Telefono" aria-describedby="inputGroupPrepend2" required>
      </div>
    </div>


  </div>
  <button onclick="cotizacionStep1()" class="gv-btn-medium gv-primary gv-text-color-white width-only-content" style="margin:10px 0px 0px 0px;width:100%!important;height:auto;"  class="btn btn-primary" >Descargar cotización</button>
</form>
