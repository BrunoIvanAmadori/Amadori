...
<div id="page container-fluid" class="site">
	...
	<header id="tophead" class="container-fluid">
		<div class="container d-flex justify-content-between">
			...
			<ul>
				<?php 
				//$language_table_json = file_get_contents( get_template_directory_uri() . '/inc/language-table.json' );
				// $language_table_array = json_decode($language_table_json, true);
				$language_table_json = '[
					{
					  "id": 1,
					  "code": "en",
