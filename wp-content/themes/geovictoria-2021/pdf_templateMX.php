      ...
      <div class="j-main">
         <div class="my_content">
            ...
            <div style="padding-bottom:10px">
				<div style="width: 80%; float:left">
				   ...
				   <h1 style="display:inline-block">Total:* </h1><h1 style="margin:15px 0px 0px 10px;display:inline-block;max-width:400px;background-color:white;border:1px solid gray;padding:1px;border-radius:8px;" > '.$_GET['div'].' <span> '.number_format($_GET['t'],0,".",".").' </span> '.$iva_check.' </h1>
				   <h2>Cantidad de empleados: <span>'. $_GET['uto'] .'</span> &nbsp;&nbsp;&nbsp;Tipo de plan: <span>'. $_GET['p'] .'</span></h2>
				</div>

				';

				//that means : the image doesn't exists
				if($base64_reg == "22") 
				echo '
		...
		if($_GET['tas'] > 0 ){ 
            ...
            <div>
				...
				<div style="width:auto; float:right;margin-top: -65px;">
				   <h2>'.$_GET['div'] .' <span>'. number_format($_GET['tex'],0,".",".") .'</span> <span style="font-weight:thin" >'.$iva_check_2.'</span></h2>
				</div>				
				<div class="line" style="height: 60px;"></div>
			</div>';
