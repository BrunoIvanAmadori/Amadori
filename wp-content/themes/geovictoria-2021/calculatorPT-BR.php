...
<section class="topbox">
	<div class="gv-container">
		<h2 class="gv-h2 topbox-title">Monte Seu Plano</h2>
		<p class="topbox-description">Selecione o número de funcionários, os módulos que interessam a você e ao seu setor. Você obterá o preço em apenas 3 cliques. Cobramos de acordo com o número de usuários ativos.
	</div>
</section>
				...
				<div class="calculator-info">
					<div class="columns is-vcentered">
						<div class="column is-3 gv-align-center quantity-container">
							<p>N° de funcionários</p><input class="input" id="total-empleados-input" oninput="totalEmpleadosAction()" placeholder="1" type="text">
						</div>
						...
						<div class="column is-3 resumen active" id="resumen-text"><span>Total:</span>
							<p class="total"><span id="currencyGV-box"></span> <span id="total-general">16,50</span> <?php echo $iva_check; ?> <span class="min-text">ao mês</span></p>
				...
				<div class="elements-container columns">
					<article class="element column active">
						<div onclick="actionProducts('Asistencia', 'check-asist')" style="display: contents;">
							...
							<img alt="" class="big-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_1.svg">
							<span>Controle de ponto e escalas</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span></div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Quant.:<input pattern="[0-9]*" class="input" id="total-empleados-asistencia-input" oninput="totalEmpleadosProductoAction('asist')" placeholder="0" type="text"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Acceso', 'check-acces')" style="display: contents;">
							...
							<img alt="" class="big-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_2.svg">
							<span>Controle de acesso</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Quant.:<input class="input" id="total-empleados-acceso-input" oninput="totalEmpleadosProductoAction('acces')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Comedor', 'check-comed')" style="display: contents;">
							...
							<img alt="" class="big-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_3.svg">
							<span>Portal de refeitório e restaruante</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Quant.:<input class="input" id="total-empleados-comedor-input" oninput="totalEmpleadosProductoAction('comed')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Externos', 'check-exter')" style="display: contents;">
							...
							<img alt="" class="big-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_4.svg">
							<span>Controle de Visitas</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Quant.:<input class="input" id="total-empleados-externos-input" oninput="totalEmpleadosProductoAction('exter')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
				...
				<div class="elements-container columns flex-wrap">
					...
					<article class="element column">
						<div onclick="actionProducts('Powerbi', 'check-powerbi')" style="display: contents;">
							...
							<img alt="Dashboard en power BI" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_5.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Reporte', 'check-reporte')" style="display: contents;">
							...
							<img alt="Reportes personalizados" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_6.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Formapp', 'check-formapp')" style="display: contents;">
							...
							<img alt="Formulario App" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_7.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Optimizador', 'check-optimizador')" style="display: contents;">
							...
							<img alt="Optimizador de turnos" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_8.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Integraerp', 'check-integraerp')" style="display: contents;">
							...
							<img alt="Integración con otros sistemas" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_9.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Soporte', 'check-soporte')" style="display: contents;">
							...
							<img alt="Soporte 24/7" class="small-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icons/icon_10.svg">
				...
				<article class="element column ml0" style="height: auto;width: auto;margin-top: unset;">
					<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-2 gv-align-center" style="padding:0">
							<img alt="" class="img-dt" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/reg_pt-br.jpg" width="80px" height="80px">
						</div>
					</div>
					...
					<div class="column is-3 resumen" id="cotization-pdf-btn" style="width: auto;">
						<a class="btn btn-primary" onclick="modalAction('cotizacion-modal')">Baixar informação com os valores</a>
					</div>
	...
	<div class="gv-container">
		<div class="tabs-inner-container">
			...
			<div class="tabs is-centered" id="tabs-list">
				<ul>
					<li class="tab asist-contain is-active" id="asist-tab"><a onclick="activeTab('asist-contain', 'asist-tab')">Controle de Ponto e Escalas</a></li>
					<li class="tab acces-contain" id="acces-tab"><a onclick="activeTab('acces-contain', 'acces-tab')">Controle de Acesso</a></li>
					<li class="tab comed-contain" id="comed-tab"><a onclick="activeTab('comed-contain', 'comed-tab')">Gestão de Refeitorio.</a></li>
					<li class="tab extern-contain" id="extern-tab"><a onclick="activeTab('extern-contain', 'extern-tab')">Controle de visita</a></li>
					<li class="tab adicio-contain" id="adicio-tab"><a onclick="activeTab('adicio-contain', 'adicio-tab')">Modulos Complementares</a></li>
				</ul>
			</div>
	...
	<div class="modal-content">
		<div class="gv-modal-card" style="z-index: 2;width: 450px;">
			<div class="gv-modal-card-header">
				<span id="step1-title">
					<h6>Você está a 1 passo de fazer o download do seu relatório</h6>
