...
// {
//   parameters: slideX('.step-2__entry-id--size-1', 1090, 1),
//   offset: '-=500'
// },
// {
//   parameters: slideX(['.step-2__cloud', '.step-2__cloud-aura', '.step-2__loading'], -1000),
// },
// {
//   parameters: fadeIn(['.step-2__cloud', '.step-2__loading' ]),
//   offset: '0'
// },
// // {
// //   parameters: slideX('.step-2__entry-id--size-1-b', 1500, 1),
// //   offset: '-=500'
// // },
// // {
// //   parameters: pop(['.step-2__entry-id--size-2', '.step-2__entry-id--size-3', '.step-2__entry-id--size-4', ]),
// //   offset: '-=200'
// // },
...
// // },
// {
//   parameters: translate('.step-2__entry-id--size-2', 350, -300),
//   offset: ''
// },
// {
//   parameters: {
//     targets: ".step-2__cloud",

//     scale: [{value: 1, easing: 'easeInElastic(1, .5)'},
//            {value: 0.9, duration: 100 },
//             {value: 1, easing: 'easeOutElastic(1, .5)' }
//           ],
//           easing: 'easeInOutSine',
//     duration: 300,
//   },
...
// },
// {
//   parameters: translate('.step-2__entry-id--size-1', 1190, 120),
//   offset: ''
// },
// {
//   parameters: fadeOut('.step-2__loading'),
...
// },
// // {
// //   parameters: shake('.step-2__cloud', 0.01),
// //   offset: '-=1000'
// // },
// // {
// //   parameters: shake('.step-2__cloud', 0.01),
...
// },
// // { // Se va del cuadro
// //   parameters: flyOutX('.step-2 animation-asistencia', 3840),
// //   offset: '-=200'
// // },
