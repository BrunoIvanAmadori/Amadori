...
} from "../timelines/page-comedor.js";
...
const animation_trigger_step_1 = document.querySelector(
  ".animation-comedor.step-1 .step-1__graphics"
);

const animation_trigger_step_2 = document.querySelector(
  ".animation-comedor.step-2 .step-2__graphics"
);

const animation_trigger_step_3 = document.querySelector(
  ".animation-comedor.step-3 .step-3__graphics"
);

window.addEventListener("scroll", function (e) {
  heroHeight = heroContainer.offsetHeight + heroContainer.offsetTop;
...
addAnimationTrigger(animation_trigger_step_1, comedor_animation_step_1);
