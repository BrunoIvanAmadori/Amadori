			...
			<div class="elements-container has-text-centered">
				...
				<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
					...
					<div class="column is-2 gv-align-center" style="padding:0">
						<img alt="" class="img-dt" src="/wp-content/themes/geovictoriacom/gvcalc/img/reg_pe.jpg" width="80px" height="80px">
					</div>	
				</div>
				...
				<div id="calc-side" style="margin: inherit; width: 90%;">
					...
					<div class="columns is-vcentered paddl0" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-8 gv-align-right" style="padding-bottom: unset;">
							<span class="slide-labels">S/ <span id="asistencia-box" style="display: contents;">0</span> por usuario al mes</span>
						</div>
					</div>
					...
					<div class="columns is-vcentered paddl0" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-8 gv-align-right" style="padding-bottom: unset;">
							<span class="slide-labels">S/ <span id="acceso-box" style="display: contents;">0</span> por usuario al mes</span>
						</div>
					</div>
					...
					<div class="columns is-vcentered paddl0" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-8 gv-align-right" style="padding-bottom: unset;">
							<span class="slide-labels">S/ <span id="comedor-box" style="display: contents;">0</span> por usuario al mes</span>
						</div>
					</div>
					...
					<div class="columns is-vcentered paddl0" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-8 gv-align-right" style="padding-bottom: unset;">
							<span class="slide-labels">S/ <span id="externos-box" style="display: contents;">0</span> por usuario al mes</span>
						</div>
					</div>		
				</div>
