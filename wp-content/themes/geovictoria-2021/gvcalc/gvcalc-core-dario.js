...
const gv = { //CHILE
		...
		TabAsistencia_legal_titulo: 'Certificación 1140 y 5849',
		TabAsistencia_legal_texto: 'Nuestra solución se encuentra certificada por la Dirección del Trabajo de acuerdo con los dictámenes 1140/27 y 5849 y se actualiza continuamente de acuerdo con los nuevos requerimientos legales.',
		Valores_referenciales_texto: '*Valores referenciales utilizando la UF del día',
...
const calcTarifaXPersona = (a, c, b) => {
    ...
    initCalculator = () => {
		document.getElementById("reference-val-txt").innerText = gv.Valores_referenciales_texto;
		document.getElementById("asist-cert-title").innerText = gv.TabAsistencia_legal_titulo;
		document.getElementById("asist-cert-txt").innerText = gv.TabAsistencia_legal_texto;
