				...
				<article class="element column ml0" style="height: auto;width: auto;margin-top: unset;">
					<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						<div class="column is-12 gv-align-center paddl0">
							<img alt="" class="site-branding" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/logo-gv-nuevo.png">
						</div>
					...
					<div class="column is-2 gv-align-center" style="padding:0">
						<img alt="" class="img-dt" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/pdf_reg_mx.png" width="80px" height="80px">
					</div>	-->
					</div>
