...
<section class="topbox">
	<div class="gv-container">
		<h2 class="gv-h2 topbox-title">Calculate the price</h2>
		<p class="topbox-description">Select the number of employees the modules that interest you <br> <b>You will get the price in just 3 clicks</b> We charge according to the number of active users</p>
	</div>
</section>
				...
				<div class="calculator-info">
					<div class="columns is-vcentered">
						<div class="column is-3 gv-align-center quantity-container">
							<p>N° of employees</p><input class="input" id="total-empleados-input" oninput="totalEmpleadosAction()" placeholder="1" type="text">
						</div>
						...
						<div class="column is-3 resumen active" id="resumen-text"><span>Total:</span>
							<p class="total"><span id="currencyGV-box"></span> <span id="total-general">16,50</span> <?php echo $iva_check; ?> <span class="min-text">total per month</span></p>
							<p id="total-asistencia-container">UF <span id="total-asistencia">0,00</span> <span class="min-text">At <span id="personas-asistencia">750</span> Attendance and shift control</span></p>
						</div>
				...
				<div class="elements-container columns">
					<article class="element column active">
						<div onclick="actionProducts('Asistencia', 'check-asist')" style="display: contents;">
							...
							<img alt="" class="" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/asist.png">
							<span>Attendance and shift control</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span></div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Cant.:<input pattern="[0-9]*" class="input" id="total-empleados-asistencia-input" oninput="totalEmpleadosProductoAction('asist')" placeholder="0" type="text"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Acceso', 'check-acces')" style="display: contents;">
							...
							<img alt="" class="" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/acces.png">
							<span>Access control</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Cant.:<input class="input" id="total-empleados-acceso-input" oninput="totalEmpleadosProductoAction('acces')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Comedor', 'check-comed')" style="display: contents;">
							...
							<img alt="" class="" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/comed.png">
							<span>Dinning room Portal</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Cant.:<input class="input" id="total-empleados-comedor-input" oninput="totalEmpleadosProductoAction('comed')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Externos', 'check-exter')" style="display: contents;">
							...
							<img alt="" class="" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/exter.png">
							<span>External Portal</span>
						</div>
						<div><span class="mdi"></span> <span class="mdi"></span> <span><img alt="Cantidad" class="icono-persona" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/icono-persona.svg"> Cant.:<input class="input" id="total-empleados-externos-input" oninput="totalEmpleadosProductoAction('exter')" placeholder="0" type="text" readonly="readonly"></span></div>
					</article>
				...
				<div class="elements-container columns flex-wrap">
					...
					<article class="element column">
						<div onclick="actionProducts('Powerbi', 'check-powerbi')" style="display: contents;">
							...
							<img alt="Dashboard in Power BI" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-10.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Reporte', 'check-reporte')" style="display: contents;">
							...
							<img alt="Reportes personalizados" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-11.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Formapp', 'check-formapp')" style="display: contents;">
							...
							<img alt="Formulario App" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-12.svg">
							<span>App Forms</span>
						</div>
					</article>
					...
					<article class="element column">
						<div onclick="actionProducts('Optimizador', 'check-optimizador')" style="display: contents;">
							...
							<img alt="Optimizador de turnos" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-13.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Integraerp', 'check-integraerp')" style="display: contents;">
							...
							<img alt="Integración con otros sistemas" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-14.svg">
					...
					<article class="element column">
						<div onclick="actionProducts('Soporte', 'check-soporte')" style="display: contents;">
							...
							<img alt="Soporte 24/7" class="imgmax" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/Plataforma princing-15.svg">
				...
				<article class="element column ml0" style="height: auto;width: auto;margin-top: unset;">
					<div class="columns is-vcentered" style="border-bottom: 1px solid rgba(0, 0, 0, .25);width: 100%;">
						...
						<div class="column is-2 gv-align-center" style="padding:0">
							<img alt="" class="img-dt" src="<?php echo esc_url(get_template_directory_uri()); ?>/gvcalc/img/reg_en.jpg" width="80px" height="80px">
						</div>
					</div>
					...
					<div class="column is-3 resumen" id="cotization-pdf-btn" style="width: auto;">
						<a class="btn btn-primary" onclick="modalAction('cotizacion-modal')">Download detail report with values</a>
					</div>
	...
	<div class="gv-container">
		<div class="tabs-inner-container">
			...
			<div class="tabs is-centered" id="tabs-list">
				<ul>
					<li class="tab asist-contain is-active" id="asist-tab"><a onclick="activeTab('asist-contain', 'asist-tab')">Attendance and shift control</a></li>
					<li class="tab acces-contain" id="acces-tab"><a onclick="activeTab('acces-contain', 'acces-tab')">Access control</a></li>
					<li class="tab comed-contain" id="comed-tab"><a onclick="activeTab('comed-contain', 'comed-tab')">Dinning room Portal.</a></li>
					<li class="tab extern-contain" id="extern-tab"><a onclick="activeTab('extern-contain', 'extern-tab')">External portal</a></li>
	...
	<div class="modal-content">
		<div class="gv-modal-card" style="z-index: 2;width: 450px;">
			<div class="gv-modal-card-header">
				<span id="step1-title">
					<h6>You're a <b>1 step</b> to download your report</h6>
