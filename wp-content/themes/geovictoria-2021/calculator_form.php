<form id="cotizacion-form" onsubmit="return false;">
  <div class="form-row">
    ...
    <div class="col-12 mb-3">
      ...
      <div class="input-group">
        <input placeholder="Nombre" name="name" id="name" type="text" class="form-control">
        <input placeholder="Apellido" name="lastname" id="lastname" type="text" class="form-control">
      </div>
    </div>
  ...
  <button onclick="cotizacionStep1()" class="gv-btn-medium gv-primary gv-text-color-white width-only-content" style="margin:10px 0px 0px 0px;width:100%!important;height:auto;" class="btn btn-primary">Descargar</button>
</form>