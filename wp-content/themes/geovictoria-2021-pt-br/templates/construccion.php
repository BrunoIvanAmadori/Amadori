...
<main id="primary" class="site-main">
			...
			<div class="col-12 col-md-6 mb-5">
				<div class="align-self-center pe-md-3">
					<h1 class="gray mb-3 fw-bold">
						Controla a equipe de
						construção em todos
						seus projetos
					</h1>
					<p class="fw-light mb-4 anime-fadein">
						Gerenciar pessoal interno e externo em diferentes
						tocam. Visualize e distribua os trabalhadores de acordo com o seu
						precisa. Junte-se a um novo mundo de gestão.
					</p>
	...
	<section class='container'>
		<div class="row justify-content-center">
			<h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein mb-5">
				O controle do pessoal em seu trabalho,
				<span class="fw-bold">como você nunca viu antes</span>
			</h2>
		</div>
		...
		<div class="row gx-5 gy-4 mb-5">
			...
			<div class="col-12 col-md-6 anime-fadein">
				<h4 class="fw-bold mb-4">Otimize, decida, economize</h4>

				<p>
					Você gostaria de gerenciar sua equipe em cada projeto?
					controlar o total de suas operações?
				</p>

				<p>
					Con GeoVictoria <b>administra y visualiza el personal para tus obras de construcción.</b> No importa donde tus trabajadores se encuentren. ¡Verás todo en una sola plataforma!
				<p>
					A partir de vários sistemas de marcação, fornecemos informações
					informações precisas sobre a assistência de seus trabalhadores e acesso a
					pessoal externo em tempo real.
				</p>

				<p>
					Você poderá tomar decisões instantaneamente. Antecipe as necessidades
					de pessoal de acordo com o projeto que você deve gerenciar. <b> Aqui e agora! </b>
				</p>
		...
		<div class="row gy-4 flex-column-reverse flex-md-row">
			<div class="col-12 col-md-6 anime-fadein">
				<h4 class="fw-bold mb-4">Simples, rápido e amigável</h4>
				<p>
					GeoVictoria permite que você administre, gerencie e obtenha
					relatórios do atendimento do seu capital humano.</p>
				<p>Graças à nossa plataforma você saberá os atendimentos, atrasos ou
					ausências. Você vai gerenciar as horas extras dos trabalhadores para cada
					esboço, projeto. Acesso centralizado a autorizações, licenças ou férias.</p>
				<p><b>Automatize a gestão de pessoal em todos os seus canteiros de obras!</b>
				</p>
			</div>
			<div class="col-12 col-md-6 d-flex flex-column justify-content-center">
	...
	<section class="d-flex flex-column container justify-content-between features">
		...
		<div class="row justify-content-center anime-fadein-childs">
			<div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
				...
				<h6 class="fw-bold">Otimize a equipe
				</h6>
				<p>Graças à nossa aliança com o <b> Foco en Obra </b>,
					planeje a equipe que
					é necessário no projeto de acordo com
			...
			<div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
				...
				<h6 class="fw-bold">Vários sistemas de marcação</h6>
				<p>Temos dispositivos diferentes de acordo com
					suas necessidades. Os trabalhadores
					ou pessoal externo marcará por
					aplicativo móvel ou relógios biométricos.
				</p>
			</div>
			...
			<div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
				...
				<p>No aplicativo ou na web,
					os supervisores verão a tempo
					real, a presença de trabalhadores
					nos diferentes projetos de
					usuários ou equipes. </p>
			</div>
		</div>
	</section>
		...
		<section class="d-flex flex-column container justify-content-between">
			<div class="row mb-5">
				<div class="col-12">
					<div class="testimonal__video text-center">
						<h1 class="fw-bold anime-fadein mb-5">História de sucesso: Ictino</h1>
			...
			<div class="row gy-5 gx-5 anime-fadein-childs">
				<div class="col-lg-4 text-center">
					...
					<p>
						“Com a GeoVictoria os colaboradores
						podemos discar a partir do aplicativo e nós
						economize esforços em dispositivos em cada
						um dos projetos. Podemos ver o
						relatórios de horas, faltas
						e atrasos rapidamente. "
					</p>
					<p>
						<span class="fw-bold">
				...
				<div class="col-lg-4 text-center">
					...
					<p>
						“É um sistema muito amigável. Tenho
						certeza de que o registro de atendimento é o
						Direito. A plataforma e os relatórios estão em
						tempo real. Você pode ver o relatório de
						pessoal por obra. Nos ajuda
				...
				<div class="col-lg-4 text-center">
					...
					<p>
						“O fato de poder entrar para ver os dados
						assistência em um navegador, é algo
						tão simples que facilita o gerenciamento. eu sei
						torna mais eficiente, mais rápido. Este é
						um dos principais fatores que
						fez a GeoVictoria escolher. "
					</p>
					<p>
						<span class="fw-bold">
							Eurocorp
		...
		<section class="d-flex justify-content-between container why-us">
			<div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3 anime-fadein">
				...
				<p>
					...
					o projeto atribuído. Otimize e economize!
				</p>
