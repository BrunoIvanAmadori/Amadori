<?php
/*
Template Name: Reloj Control CO
*/
get_header();
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 titulo titulo-acceso">
                    <h1><span class="sub-relojcontrol">Reloj Control</span> de Asistencia</h1>
                    <p>El mejor sistema para el control y
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="formulario form-acceso">
                        <?php include_once( 'formularioZohoCO.php' ); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h2 class="titulo-azul">el reloj control de asistencia?</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Tipos de reloj control para la asistencia</h2>
                </div>
                <div class="col-lg-4 col-sm-6">
                    ...
                    <p class="text-justify">Registrar la asistencia de tus colaboradores es más fácil cuando solo necesitan su huella dactilar. Aplicable a reloj control
                    con huelleros USB y reloj control box.</p> 
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/rostroazul.png" alt="">
                    ...
                    <p class="text-justify">El reloj control box de asistencia lee rasgos faciales. El equipo es capaz de diferenciar una fotografía y un rostro real. Puede
                    almacenar hasta 100 mil caras. Especial para empresas que buscan innovadores métodos de marcaje.</p> 
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">Este reloj control de asistencia puede registrar 600 palmas, 3.000 huellas y hasta 10.000 tarjetas. Con una verificación
                    de identidad menor a un segundo, tiene avanzados algoritmos biométricos de reconocimiento de palma y huella digital.
                    Ideal para empresas que buscar un versátil reloj control de asistencia.</p>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/tarjeta.png" alt="">
                    ...
                    <p class="text-justify">Para quienes prefieren la clásica tarjeta de registro para la entrada y salida de colaboradores de sus puntos de trabajo,
                    GeoVictoria tiene un reloj control de asistencia que utiliza tarjetas enroladas a tus trabajadores. E incluso, ¡son reutilizables!
                    Olvídate de comprar nuevas tarjetas.</p>
                </div>  
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">Un reloj control de asistencia con una protección extrema. El box será protegido por un gabinete metálico a prueba de
                    robos y daños externos.</p>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">Ideal para faenas mineras o de construcción. Elaborada con un revestimiento de goma de alta protección, está diseñado
                    para ser fácilmente transportable. En este reloj control de asistencia, los trabajadores pueden registrar por huella dactilar,
                    PIN o tarjeta. Cuenta con conexión 3G para zonas extremas.</p> 
                </div>
            </div>
        </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p>Todos los equipos de reloj control de asistencia pueden
                    guardar hasta 10 mil usuarios en cualquiera de sus
                    formatos (huella dactilar, palma, facial, PIN de seguridad,
                    tarjeta, entre otros).</p>
            </div>                
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Los usuarios generan marcas gracias a registros biométricos por huella dactilar, rostro o palma. Esta información, es subida
                    a una nube de almacenamiento donde, gracias al sofisticado software de reporteria de GeoVictoria, generas poderosos reportes en tiempo real.</p>
...
<section id="forma1-section6">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>Conoce la opinion de nuestro reloj control de asistencia</h2>
