			...
			<div class="row gx-5 anime-fadein mb-5">
				...
				<div class="col-lg-8 pe-lg-5 mb-5">
					<div class="testimonal__video text-center">
						<video controlsList="nodownload" width="100%" poster="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/outsourcing/caso-outsourcing-grupofiloa-thumb.jpg" controls>
							<source src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/outsourcing/caso-outsourcing-grupofiloa.mp4" type="video/mp4">
						</video>
					</div>
				</div>

				<div class="col-lg-4 text-center text-lg-start">
					<h4 class="fw-bold mb-3">Caso de éxito: Grupo FILOA</h4>
					<p>
						<!-- <img class="arrow-quote--left" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/call-to-action/arrow.svg"> -->
						<i>“Tiene un sistema muy amigable, muy completo. Nos ha apoyado mucho en el proceso de la información. Ahora, tenemos un sistema más esbelto, eficaz y ha reducido nuestros niveles de rotación” </i>
					...
					<div class="row justify-content-center justify-content-lg-start">
						<span>
							<span class="fw-bold">Guillermo Montes</span></br>
						</span>
					</div>
				</div>
			</div>
