			...
			<div class="row gx-5 anime-fadein mb-5">
				...
				<div class="col-lg-7 pe-lg-5 mb-5">
					<div class="testimonal__video text-center">
						<video controlsList="nodownload" width="100%" poster="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/retail/caso-retail-starbucks-thumb.jpg" controls>
							<source src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/retail/caso-retail-starbucks.mp4" type="video/mp4">
						</video>
					</div>
				</div>
				...
				<div class="col-lg-5 text-center text-lg-start">
					...
					<p>
						...
						<i>“Ha sido una tremenda herramienta que hemos podido entregar a nuestros gerentes de tienda. No solamente por lo práctica que es, lo fácil de operar que es, sino que además es una herramienta que eleva su gestión”</i>
					...
					<div class="row justify-content-center justify-content-lg-start">
						<div class="col-lg-4">
							<img class="testimonial__logo--huawei" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/logos/starbucks-logobnw.png" />
						</div>
						<div class="col-lg-8 align-self-center">
							<span>
								<span class="fw-bold">María José Ugalde</span></br>
								<small>Subgerenta de RR.HH.</small>
							</span>
						</div>
					</div>
				</div>
