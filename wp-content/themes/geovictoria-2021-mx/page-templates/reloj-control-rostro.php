...
/*
Template Name: Reloj Control con Rostro
*/
...
<main id="primary" class="site-main">
            ...
            <div class="col-12 col-md-6 mb-5">
                <div class="align-self-center pe-md-3 text-lg-end text-center">
                    <div class="hero__graphics col-12 justify-content-lg-end justify-content-center">
                        <img class="hero__img--small anime-pop" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/relojescontrol-rostro.png'>
                    </div>
                    <h1 class="gray mb-3 fw-bold">
                        Reloj Control con Rostro
                    </h1>
                    <p class="fw-light mb-4 anime-fadein">
                        El mejor sistema para el control y
                        gestion de asistencia en latinoamérica.
                        Gracias al sofisticado <b>reloj control con rostro</b>
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">¿Cómo funciona
                el <b>reloj Control con lectura de rostro</b>?</span></h2>
        </div>
        ...
        <div class="row gx-5 gy-4 mb-5">
            ...
            <div class="col-12 col-md-6 anime-fadein">
                <p>El <b>reloj control con rostro</b> es uno de los sistema de control y gestión de personas más innovadores del mercado. </p>
                ...
                <p>El reloj control con lectura de rasgos faciales, almacena la información del ingreso y egresos de trabajadores en tiempo real.</p>
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein"><b>Reloj control multibiométrico</b> que registra rasgos faciales:</span></h2>
        </div>

        <div class="row gx-5 gy-4 mb-5">
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                <img class="anime-pop" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/uFace800Grande.png'>
            </div>
            <div class="col-12 col-md-6 anime-fadein">
    ...
    <section class="d-flex flex-column container justify-content-between features">
        <div class="row">
            <h2 class="text-center fw-bold gray section-title anime-fadein"><span class="fw-light">Tipos de <b>reloj control con lector de rostro</b></span></h2>
        </div>
        ...
        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <h6 class="fw-bold">Reloj control Box</h6>
                <p>El clásico reloj control con huella es un box que registra asistencia por medio de la huella dactilar.
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/reloj-control-con-huellero-usb.png" />
                <h6 class="fw-bold">Reloj control con huellero USB</h6>
                <p>Para las empresas que deseen aplicar una mínima inversión, el reloj control con huellero USB (GeoVictoria USB) es la opción perfecta.
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <p>Un reloj control con huella protegido por un gabinete metálico a prueba de robos y daños externos.</p>
            </div>
        ...
        <div class="row justify-content-center anime-fadein-childs">
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/reloj-control-multibiometrico.png" />
                <h6 class="fw-bold">Reloj control multibiométrico</h6>
                <p>El reloj control box multibiométrico de asistencia no solo lee la huella dactilar.
            ...
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/reloj-maletin.png" />
                <h6 class="fw-bold">Reloj Maletín</h6>
                <p>Ideal para faenas mineras o de construcción. Elaborada con un revestimiento de goma de alta protección, está diseñado para ser fácilmente transportable.
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <div class="col-12">
                <h2><span class="fw-light">Características del <b>reloj control con rostro</b></span></h2>
            </div>
    ...
    <div class="container-fluid bg-blue-2">
        <section class="d-flex justify-content-between container why-us">
            <div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3 anime-fadein-childs">
                ...
                <p>El <b>reloj control con rostro</b> de GeoVictoria facilita el registro del ingreso y egreso del personal por medio de un reloj control adaptado a tu negocio.
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <h2><span class="fw-light">Características del <b>reloj control con rasgos faciales</b> de GeoVictoria</span></h2>
            <div class="col-12 d-flex flex-column justify-content-center">
                <img class="hero__img--small anime-pop" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/uFace800Grande.png'>
            </div>
    ...
    <div class="position-relative">
        ...
        <section class='container'>
            <div class="row mb-5 justify-content-center">
                <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">Beneficios del <b>reloj control de rostro</b> </h2>
            </div>
            ...
            <div class="row gx-5 gy-4 mb-5">
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>Equipos certificados y validados por la Inspección del Trabajo. La última generación de aparatos biométricos de reloj control que reconoce rasgos faciales en el mundo. </p>
                </div>
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    <h3 class="fw-bold mb-4">Fácil instalación</h3>
                    <p>El reloj control con lector de rasgos faciales necesita un cable de corriente, una conexión LAN de la empresa y ¡listo!, ya puede ser utilizado. Solo conexión 3G en caso de solo requerir una Fuente de Energía.
                    </p>
                </div>
            </div>
            ...
            <div class="row gx-5 gy-4 mb-5">
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>La biometría contempla todos los atributos identificables únicos de las personas. En GeoVictoria, el reloj control de asistencia usa
    ...
    <div class="position-relative">
        ...
        <section class="d-flex flex-column container justify-content-between text-center">
            <div class="row gx-5 anime-fadein mb-5">
                <h2 class="text-center mb-5">Conoce la opinion de nuestro <b>reloj control de rostro</b></h2>
