<?php
/*
Template Name: RelojChecador Huella
*/
get_header();
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 titulo titulo-acceso">
                    <h1><span class="sub-relojcontrol">Reloj Checador</span> con Huella</h1>
                    <p>El mejor sistema para el control y gestion de asistencia en México y  latinoamérica. Gracias al sofisticado reloj checador con huella por GeoVictoria, 
                    contarás con datos fidedignos y en tiempo real de la presencia de empleados de las empresas mexicanas. 
                    </p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h2 class="titulo-azul">el reloj checador con huella de asistencia?</h2>
                <p>El reloj checador con huella de asistencia es el sistema de control y gestión de personas más eficiente del mercado.</p>
                ...
                El reloj checador con huella, almacena la información del ingreso y egresos de trabajadores en tiempo real. </p>
                <p>Bajo el soporte de GeoVictoria, cuenta con poderosas herramientas de reportería, como gestión de asistencia, remuneraciones, faltas, 
                ausencias, retardos, tiempos extras,  generación de alertas, permisos, vacaciones, feriados, entre otros. Integrado a todos los softwares RR.HH. y ERP del mercado.
                </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Tipos de reloj checador con huella para la asistencia</h2>
                </div>
                <div class="col-md-12">
                    <h3 class="text-center">Reconocimiento huella dactilar:</h3>
                    <p class="text-justify">Registrar la asistencia de tu personal es más fácil cuando solo necesitan su huella dactilar. Aplicable a reloj checador con huelleros USB y reloj checador box.  
                    Para ello contamos con tres modelos de relojes checadores que logran registrar hasta 3000 huellas. Estos son los siguientes equipos relojes checadores que contamos en México y respaldado por ZK:</p> 
                </div>
                <div class="col-md-4">
...
<section id="forma2-section1" class="acceso">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center titulo-relojcontrol">Características del reloj checador con huella</h2>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <p>El reloj checador con huella se adapta tanto a las conexiones locales de la empresas, como a las inalámbricas por datos móviles.</p>
            
                <h3 class="subtitulo">Diversas versiones para diferentes escenarios (con gabinete o impresora):</h3>
                <p>Sea en un gabinete o en una impresora, el reloj checador con huella de  GeoVictoria, puede ser instalado en el lugar donde la empresa determine. 
                    Y si el administrador lo necesita, el reloj checador con huella imprimirá un ticket que comprueba su asistencia. 
                </p>
                ...
                <p>Todos los equipos de reloj checador con huella pueden guardar hasta 3000 usuarios.</p>
            </div>                
        </div>
    </div>
</section>
<section id="forma1-section4" class="relojcontrol">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>¿Cómo el reloj checador con huella de GeoVictoria facilita tu gestión de planilla?</h2>
                <p>El reloj checador de asistencia de GeoVictoria facilita el registro de la entrada y salida del personal por medio de un reloj checador con huella adaptado a tu empresa y planilla.</p>
                <p>Los empleados generan marcas gracias a registros biométricos por huella dactilar. Esta información, es subida a una nube de almacenamiento donde,
                     gracias al sofisticado software de  reportes hechos por GeoVictoria, sabrás  en tiempo real las checadas de los empleados.  
                </p>
...
<section id="forma2-section1" class="acceso2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2>Propiedades del Reloj Checador con huella de GeoVictoria</h2>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <p>Una vez instalado el equipo reloj checador con huella y software de gestión de personas de GeoVictoria, accede a un equipo de soporte al cliente, que te apoyará en toda duda o problema. </p>
                    </li>
                    <li>
                        <h3>Fácil Instalación:</h3>
                        <p>El reloj checador con huella solo necesita un cable de corriente y  conexión LAN de la empresa y ¡listo!, ya puede ser utilizado. Solo conexión 3G en caso de solo requerir una Fuente de Energía.</p>
                    </li>
                </ul>
                <div class="col text-center">
                    <a href="#"><button>Quiero hacer más simple mi gestión</button></a>
...
<section id="forma1-section6" class="acceso2">
        <div class="container acceso3">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Beneficios del reloj checador con huella</h2>
                </div>
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p class="text-justify">La última generación de aparatos biométricos de reloj checador con huella en el mundo ahora en México.</p> 
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">La información de las checadas es más fácil de obtener al verlas con el software de control de asistencia de GeoVictoria. ¡Ahórrate en pasar información al Excel!</p> 
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                        <img src="https://www.geovictoria.com/wp-content/uploads/2020/04/ab7fce46-normativa_00000001n01s003000001.png" alt="">
                    ...
                    <p class="text-justify">La biometría contempla todos los atributos identificables únicos de las personas. En GeoVictoria, 
                        el reloj checador con huella usa algunos de estos rasgos para validar su identidad. Así, el registro de asistencia es más seguro, oportuno e infalible ante fraudes. 
                    </p>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">El administrador puede configurar de forma sencilla el aparato reloj checador con huella ante cualquier percance.</p>
                </div>  
            </div>
        </div>
</section>
<section id="forma1-section6">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>Conoce la opinion de nuestro reloj checador con huella</h2>
