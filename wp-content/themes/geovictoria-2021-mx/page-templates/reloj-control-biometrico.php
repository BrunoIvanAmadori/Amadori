...
/*
Template Name: Reloj Checador Biométrico (MX)
*/
...
<main id="primary" class="site-main">
            ...
            <div class="col-12 col-md-6 mb-5">
                <div class="align-self-center pe-md-3 text-lg-end text-center">
                    ...
                    <p class="fw-light mb-4 anime-fadein">
                        El mejor sistema para el control y gestion de asistencia en latinoamérica.
                        Gracias al sofisticado <b>reloj checador biométrico</b> suministrado por GeoVictoria,
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">¿Cómo funciona
                el <b>reloj checador biométrico</b>?</span></h2>
        </div>
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">Tipos de <b>reloj checador para la asistencia</b> en México</span></h2>
        </div>

        <div class="row gx-5 gy-4 mb-5">
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                <img class="anime-pop" src="https://www.geovictoria.com/wp-content/uploads/2020/04/relojchecador3.png">
            </div>
            <div class="col-12 col-md-6 anime-fadein">
        ...
        <div class="row gx-5 gy-4 mb-5">
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                <img class="anime-pop" src="https://www.geovictoria.com/wp-content/uploads/2020/04/relojchecador2.png">
            </div>
            <div class="col-12 col-md-6 anime-fadein">
                <h6 class="fw-bold">Reconocimiento facial</h6>
                <p>El reloj checador box de asistencia lee rasgos faciales uno de los tantos atributos biométricos para el control de asistencia.
                    El equipo es capaz de diferenciar una fotografía y un rostro real. Puede almacenar hasta 100 mil caras. Especial para empresas que en México buscan innovadores métodos de marcaje.</p>
                <h4>SilkBio-100TC</h4>
        ...
        <div class="row gx-5 gy-4 mb-5">
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                <img class="anime-pop" src="https://www.geovictoria.com/wp-content/uploads/2020/04/relojchecador1.png">
            </div>
            <div class="col-12 col-md-6 anime-fadein">
                <h6 class="fw-bold">Lector de Tarjeta</h6>
                <p>Para quienes prefieren la clásica tarjeta de registro para la entrada y salida de empleados de sus sucursales de trabajo,
    ...
    <div class="container-fluid bg-blue-2">
        <section class="d-flex justify-content-between container why-us">
            <div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3 anime-fadein-childs">
                ...
                <p>El reloj checador de asistencia de GeoVictoria facilita el registro del ingreso y egreso del personal por medio de un reloj control adaptado a tu empresa.</p>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <h2><span class="fw-light">Características del <b>reloj checador biométrico</b> de GeoVictoria</span></h2>
    ...
    <div class="position-relative">
        ...
        <section class='container'>
            <div class="row mb-5 justify-content-center">
                <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">Beneficios del <b>reloj checador biométrico</b> </h2>
            </div>
            ...
            <div class="row gx-5 gy-4 mb-5">
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>La última generación de aparatos biométricos de reloj checador biométricos en el mundo ahora en México.</p>
                </div>
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
            ...
            <div class="row gx-5 gy-4 mb-5">
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>La biometría contempla todos los atributos identificables únicos de las personas.
                        En GeoVictoria, el reloj checador biométrico usa algunos de estos rasgos para validar su identidad. <br>
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>El administrador puede configurar de forma sencilla el aparato reloj checador biométrico ante cualquier percance.
                    </p>
                </div>
            </div>
