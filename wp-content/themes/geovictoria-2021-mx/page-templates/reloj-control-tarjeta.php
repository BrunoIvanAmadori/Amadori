...
/*
Template Name: Reloj Control con Tarjeta
*/
...
<main id="primary" class="site-main">
            ...
            <div class="col-12 col-md-6 mb-5">
                <div class="align-self-center pe-md-3 text-lg-end text-center">
                    ...
                    <h1 class="gray mb-3 fw-bold">
                        Reloj Control con Tarjeta
                    </h1>
                    <p class="fw-light mb-4 anime-fadein">
                        El mejor sistema para el control y gestión de asistencia en latinoamérica. Gracias al sofisticado Reloj Control con Tarjeta proporcionado por GeoVictoria,
                        contarás con datos fidedignos y en tiempo real de la asistencia de los trabajadores.
                    </p>
                </div>
            </div>
    ...
    <section class='container'>
        ...
        <div class="row mb-5 justify-content-center">
            <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">¿Cómo funciona
                el <b>Reloj Control con Tarjeta</b>?</span></h2>
        </div>
        ...
        <div class="row gx-5 gy-4 mb-5">
            ...
            <div class="col-12 col-md-6 anime-fadein">
                ...
                <p>El Reloj Control con Tarjeta, almacena la información del ingreso y egresos de trabajadores en tiempo real. Bajo el soporte de GeoVictoria,
                    cuenta con poderosas herramientas de reportería, como gestión de asistencia, remuneraciones, atrasos, ausencias, tiempos extras, reportería, permisos entre otros.
                </p>
                <p>100% compatible con la normativa chilena e integrado a todos los softwares RR.HH. y ERP del mercado.</p>
            </div>
        </div>
    </section>
    ...
    <section class="d-flex flex-column container justify-content-between features">
        <div class="row">
            <h2 class="text-center fw-bold gray section-title anime-fadein"><span class="fw-light">Tipos de <b>Reloj Control con Tarjeta</b></span></h2>
        </div>
        ...
        <div class="row justify-content-center anime-fadein-childs">
            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                ...
                <h6 class="fw-bold">Reloj Control con Tarjeta y huella</h6>
                <p>Este reloj control posee la funcionalidad de registro tanto por huella dactilar como por tarjeta.
                    Tiene un error en el reconocimiento de identidad en torno al 0.0001 %. Soporta hasta 10 mil tarjetas RFID. Es multiconfigurable,
                    optando por varias opciones de registro de asistencia, entre ellas, tarjeta + huella, solamente con tarjeta y tarjeta + password (PIN).</p>
            </div>

            <div class="d-flex col-12 col-md-6 col-lg-4 px-4 mt-4 flex-column">
                <img class="features__icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/reloj-control/reloj-maletin.png" />
                <h6 class="fw-bold">Reloj Maletín con tarjeta</h6>
                <p>Ideal para faenas mineras o de construcción. Elaborada con un revestimiento de goma de alta protección, está diseñado para ser fácilmente transportable.
                    En este reloj control es ideal para usar tarjetas RFID, pero también los trabajadores pueden registrar por huella dactilar. Cuenta con conexión 3G para zonas extremas.</p>
            </div>
        </div>
    </section>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <div class="col-12">
                <h2><span class="fw-light">Características del <b>Reloj Control con Tarjeta</b></span></h2>
            </div>
            <div class="d-flex col-12 px-4 mt-4 flex-wrap">
                ...
                <div class="col-12 col-md-6 mt-5">
                    ...
                    <p>Sea en un gabinete o en una impresora, el Reloj Control con Tarjeta de GeoVictoria, puede ser instalado en el lugar donde la empresa determine.
                        Si el Usuario lo necesita, el Reloj Control con Tarjeta imprimirá un ticket que comprueba su asistencia.
                    </p>
                </div>
    ...
    <div class="container-fluid bg-blue-2">
        <section class="d-flex justify-content-between container why-us">
            <div class="col-12 col-md-6 text-center text-md-start align-self-center pe-3 anime-fadein-childs">
                ...
                <p>El Reloj Control con Tarjeta de GeoVictoria facilita el registro del ingreso y egreso del personal por medio de un reloj control adaptado a tu negocio.</p>
                <p>Los usuarios generan marcas gracias a las tarjetas RFID, uno de los métodos más sencillos del mercado. </p>
                <p>La información del registro del personal, es subida a una nube de almacenamiento donde, gracias al sofisticado software de reportería de GeoVictoria, generas poderosos reportes en tiempo real.</p>
    ...
    <section class='container'>
        <div class="row gx-5 gy-4 mb-5 text-center">
            <h2><span class="fw-light">Características del <b>Reloj Control con Tarjeta de GeoVictoria</b></span></h2>
            ...
            <div class="d-flex col-12 col-md-6 px-4 mt-4 flex-column">
                ...
                <p>El reloj control con tarjeta de GeoVictoria opera con los softwares de Recursos Humanos y ERP más importantes del mercado. Así, puedes saber cuanta remuneración pagar a partir de los datos de asistencia de los usuarios.</p>
            </div>
            <div class="d-flex col-12 col-md-6 px-4 mt-4 flex-column">
    ...
    <div class="position-relative">
        ...
        <section class='container'>
            <div class="row mb-5 justify-content-center">
                <h2 class="col-12 col-lg-8 align-self-center text-center gray fw-light anime-fadein">Beneficios del <b>Reloj Control con Tarjeta</b> </h2>
            </div>
            ...
            <div class="row gx-5 gy-4 mb-5">
                ...
                <div class="col-12 col-md-6 anime-fadein d-flex flex-column justify-content-center">
                    ...
                    <p>El administrador puede configurar de forma sencilla el aparato <b>reloj control con tarjeta</b> ante cualquier percance.
                    </p>
                </div>
            </div>
    ...
    <div class="position-relative">
        ...
        <section class="d-flex flex-column container justify-content-between text-center">
            <div class="row gx-5 anime-fadein mb-5">
                <h2 class="text-center mb-5">Conoce la opinión de nuestro <b>reloj control con tarjeta</b></h2>
