<?php
/*
Template Name: RelojChecador Tarjeta
*/
get_header();
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 titulo titulo-acceso">
                    <h1><span class="sub-relojcontrol">Reloj Checador</span> con Tarjeta</h1>
                    <p>El mejor sistema para el control y gestion de asistencia en México y  latinoamérica. Gracias al sofisticado reloj checador con tarjeta de GeoVictoria, 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h2 class="titulo-azul">el reloj checador con tarjeta?</h2>
                <p>El reloj checador con tarjeta es el sistema de control y gestión de personas más eficiente del mercado en México.</p>
                <p>El aparato proporcionado por GeoVictoria permite el registro e identificación de empleaos para el registro de su presencia en su trabajo. 
                    El reloj checador con tarjeta almacena la información del ingreso y egresos de trabajadores en tiempo real.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Tipos de reloj checador con tarjeta para la asistencia en México</h2>
                </div>
                <div class="col-md-12">
                    <h3 class="text-center">Lector de tarjeta:</h3>
                    <p class="text-justify">Este reloj checador con tarjeta es perfecto para administradores que prefieren clásicos métodos de control para la entrada y
                         salida de empleados en sus puntos de trabajo. GeoVictoria tiene un reloj checador de asistencia que utiliza tarjetas enroladas a tus empleados. 
                         E incluso, ¡son reutilizables! Olvídate de comprar nuevas tarjetas. </p> 
                         <h4>Todos nuestros equipos para el control de asistencia tienen capacidad para marcar hasta 3000 tarjetas de RFID.</h4>
                </div>
                <div class="col-md-4">
...
<section id="forma2-section1" class="acceso">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center titulo-relojcontrol">Características del reloj checador con tarjeta</h2>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <p>El reloj checador de asistencia con tarjeta se adapta tanto a las conexiones locales de la empresas, como a las inalámbricas por datos móviles.</p>
            
                <h3 class="subtitulo">Diversas versiones para diferentes escenarios (con gabinete o impresora):</h3>
                <p>Sea en un gabinete o en una impresora, el reloj checador con tarjeta de GeoVictoria, puede ser instalado en el lugar donde la empresa determine. 
                    Y si el administrador lo necesita, el reloj checador de asistencia imprimirá un ticket que comprueba su asistencia. 
                </p>
                ...
                <p>Todos los equipos de reloj checador con tarjeta pueden guardar hasta 10 mil usuarios usando la tecnología RFID.</p>
            </div>                
        </div>
    </div>
</section>
<section id="forma1-section4" class="relojcontrol">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>¿Cómo el reloj checador de GeoVictoria facilita tu gestión?</h2>
                ...
                <p>Los usuarios generan marcas gracias a registros por la clásica tarjeta RFID. Esta información, 
...
<section id="forma2-section1" class="acceso2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2>Propiedades del Reloj Checador con Tarjeta de GeoVictoria</h2>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <p>El software de GeoVictoria está hecho para que sepas que tantas horas extras generas, 
                            el promedio de retardo de los usuarios, permisos otorgados. Algunos de ellos son: </p>
                            <ul>
                                <li>
                    ...
                    <li>
                        ...
                        <p>El reloj checador con tarjeta de GeoVictoria opera con los softwares de Recursos Humanos y 
                            ERP más importantes del mercado. Así, puedes saber cual es la  nómina a pagar gracias a los datos de asistencia del personal.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>Una vez instalado el equipo reloj checador con tarjeta RFID  y software de gestión de personas de GeoVictoria, accede a un equipo de soporte al cliente, que te apoyará en toda duda o problema. </p>
                    </li>
...
<section id="forma1-section6" class="acceso2">
        <div class="container acceso3">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Beneficios del reloj checador con tarjeta de asistencia</h2>
                </div>
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p class="text-justify">La última generación de relojes checadores con tarjeta en el mundo ahora en México.</p> 
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p class="text-justify">Los datos de asistencia que provee el reloj checador con tarjeta, permite administrar el personal de acuerdo al rubro donde trabajan.
                        En retail podrán determinar la dotación de colaboradores necesarias por sucursal y en outsourcing, sabrás en que punto hace faltan
                    </p>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center">
                    ...
                    <p class="text-justify">El administrador puede configurar de forma sencilla el aparato reloj checador con tarjeta de asistencia ante cualquier percance.</p>
                </div>  
            </div>
        </div>
</section>
<section id="forma1-section6">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>Conoce la opinion de nuestro reloj checador con tarjeta</h2>
